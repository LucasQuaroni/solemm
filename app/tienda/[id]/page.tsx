...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    Promise.all([getProducts(), getSettings()]).then(([products, settings]) => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="flex flex-col gap-5">
              <div>
                ...
                <h1 className="font-sans text-3xl font-bold text-foreground mt-1 text-balance">
                  {product.name}
                </h1>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-3.5 px-6 rounded-sm font-body font-semibold text-sm transition-all ${
                    added
                ...
                <button
                  ...
                  disabled={product.stock === 0}
                  className="flex-1 flex items-center justify-center gap-2 py-3.5 px-6 rounded-sm font-body font-semibold text-sm bg-[#25D366] hover:bg-[#1ebe5d] text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
              ...
              <button
                ...
                className="self-start flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors font-body"
              >
